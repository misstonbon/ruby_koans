...
The Ruby Koans walk you along the path to success in order to learn Ruby.
The goal is to learn the Ruby language, syntax, structure, and some common
functions and libraries. We also teach you Ruby culture by basing the koans on tests.
...
*nix platforms, from the +ruby_koans+ directory
    ...
    [ruby_koans] $ ruby path.rb                   # simply call the file directly

Windows is the same thing

    c:\ruby_koans\rake                             # runs the default target :walk_the_path
    c:\ruby_koans\ruby path.rb                     # simply call the file directly
...
While walking the path to Ruby accomplishment you will need to run the koan and
...
The very first time you run the koans you will see the following output:
    ...
    /usr/bin/ruby1.8 path.rb

    You stumbled over AboutAsserts#test_assert_truth.

    The Guide says:
    You have not yet reached the campground.
...
This version of Ruby Koans was adapted to avoid cultural appropriation by Ada Developers Academy.
