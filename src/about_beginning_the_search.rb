...
class BeginningTheSearch < Neo::Koan
  ...
  def test_using_built_ins
    ...
    assert_equal __(50), array.find_index(50)

    # you can also use #index
    assert_equal __(50), array.index(50)
    assert_equal __(20), array.index(20)

    # use #include? if you don't care about the location
    assert_equal __(true), array.include?(20)
    assert_equal __(false), array.include?(200)
  end
  ...
  def test_find_index_with_while
    ...
    assert_equal __(51), find_index_with_while(array, 200)
    assert_equal __(51), find_index_with_while(rando, 200)
  end
